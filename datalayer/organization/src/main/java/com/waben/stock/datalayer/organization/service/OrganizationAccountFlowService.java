	...
	public Page<OrganizationAccountFlowWithTradeInfoDto> pageAgentCapitalManageNew(AgentCapitalManageQuery query) {
		...
		String sql = String
				.format("select t1.id, t1.amount, t1.flow_no, t1.occurrence_time, t1.origin_amount, t1.remark, t1.resource_id, t1.resource_trade_no, t1.resource_type, t1.type, t1.org_id, "
						...
						+ "IF(MAX(t11.org_id)=t11.org_id, CASE "
						+ "WHEN t1.type = 7 THEN t11.sale_openwind_service_fee - t11.cost_openwind_service_fee "
						+ "WHEN t1.type = 8 THEN t11.sale_unwind_service_fee - t11.cost_unwind_service_fee "
						+ "WHEN t1.type = 9 THEN t11.sale_deferred_fee - t11.cost_deferred_fee " + "ELSE 0 END, "
						+ "CASE "
